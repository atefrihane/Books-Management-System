<template>
    <div class="container-fluid">
        <div class="card card-primary">
            ...
            <h3 class=" p-4">Update a collection</h3>
        ...
        data() {
            return {
                ...
                collection: {
                    ...
                    name: this.old_collection.name,
                    photo: this.old_collection.photo,
        ...
        methods: {
            ...
            submitAddCollection() {
                ...
                if (validate) {
                    ...
                    body.append('id', this.old_collection.id)
                    ...
                    axios.post(`/api/collection/${this.collection.id}/update`, body, config)
                        .then((response) => {
                            this.isActive = false;
