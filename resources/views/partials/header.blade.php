    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                ...
                <a href="#" class="dropdown-item dropdown-footer">Tout les messages</a>
            </div>
        </li>
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                <a href="{{route('showArticles')}}" class="nav-link {{ Route::is('showArticles') ? 'active' : '' }}">
                        <i class="fas fa-book"></i> &nbsp;
                        <p>Articles</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{route('showAuthors')}}" class="nav-link {{ Route::is('showAuthors') ? 'active' : '' }}">
